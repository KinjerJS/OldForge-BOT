 ...
 * @since 1.0.3
 */
public class ModHelpCmd extends Command {
	...
	public String getDescription() {
		return "Affiche une liste des demande d'aides résolus en fonction des arguments";
	}
	...
	public void execute(TextChannel channel, User sender, String[] args, Message msg) {
		if (args.length == 0)
			...
			if (obj.get("message") != null)
				channel.sendMessage(error().setDescription("Il n'existe aucune demande d'aide résolu avec ce sujet").build()).queue();
			else {
