...
public class TutorialCmd implements Command {
	...
	public void execute(SlashCommandInteractionEvent event) {
		...
		if (obj.get("message") != null)
			event.replyEmbeds(error().setDescription("Aucun résultat ne correspond à votre recherche").build()).queue();
		else {
	...
	public SlashCommandData getData() {
		return new CommandDataImpl("tutorial", "Affiche une liste des tutoriels disponibles en fonction des arguments")
				.addOption(OptionType.STRING, "name", "Nom du tutoriel", true)
				.addOption(OptionType.STRING, "version", "Affiche les tutoriels de la version spécifiée");
